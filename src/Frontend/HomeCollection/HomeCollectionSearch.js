...
const HomeCollectionSearch = () => {
  ...
  const searchCollectionHandler = () => {
    ...
    axios
      .post("api/v1/HomeCollectionSearch/GetData", updatedFormData)
      .then((res) => {
      ...
      <div className="box with-border">
        ...
        <div className="box-body">
          <div className="row">
            ...
            <label className="col-sm-1" htmlFor="From">
              {t("To Date")} :
            </label>
            <div className="col-sm-1">
              <DatePicker
            ...
            <label className="col-sm-1" htmlFor="Prebooking No.">
              PrebookingNo:
            </label>
          ...
          <div className="row">
            ...
            <label className="col-sm-1 " htmlFor="PinCode">
              {t("Pincode")} :
            </label>
            <div className="col-sm-2">
              <Input
          ...
          <div className="row">
            <label className="col-sm-2 " htmlFor="Drop Location">
              {t("Drop Location")} :
            </label>
            <div className="col-sm-2">
              <SelectBox
            ...
            <label className="col-sm-1 " htmlFor="Route">
              {t("Route")} :
            </label>
            <div className="col-sm-2">
              <SelectBox
        ...
        >
          ...
          <div className="status-item">
            <button
              ...
              onClick={() => {
                handleStatusButton("CancelRequest");
              }}
            ></button>
            <label htmlFor="CancelRequest" className="control-label">
              {t("Cancel Request")}
            </label>
          </div>
          <div className="status-item">
                ...
                <tbody>
                  {collectionList.map((ele, index) => (
                    <>
                      <tr
                        key={index}
                        style={{ backgroundColor: getColor(ele.CStatus) }}
                      >
                        <td data-title="#">
                          <div
                            style={{
                        ...
                        <td data-title="CreateBy">{ele.PatientName}&nbsp;</td>
                        <td data-title="AppDate">{ele.City}&nbsp;</td>
                        <td data-title="Locality">{ele.Locality} &nbsp;</td>
                        <td data-title="Pincode">{ele.PinCode}&nbsp;</td>
                        <td data-title="Route">{ele.RouteName}&nbsp;</td>
                        ...
                        <td data-title="Drop Location">{ele.Centre} &nbsp;</td>
