...
const HomeCollectionPatientEdit = () => {
    ...
    const fetchLocality = (id) => {
        ...
        axios.post('api/v1/CustomerCare/BindLocality', postdata)
            .then((res) => {
                let data = res.data.message;
                let value = data.map((ele) => {
                    return {
    ...
    const handleSearch = async () => {
        ...
        setPhleboTable(null)
        if (mobile.length === 10) {
            await axios.post("api/v1/updatehc/BindOldPatientHC", {
                mobile: mobile
            })
                .then((res) => {
                ...
                .catch((err) => {
                    setLoading(false);
                    console.log(err);
                    toast.error(err?.res?.data ? err?.res?.data : 'No Patient registerd ')
                });
            setLoading(false);
        } else {
    ...
    const handleSelectChange = async (event) => {
        ...
        if (name === 'StateId' || name === 'CityId' || name === 'LocalityId') {
            if (name === 'StateId') {
                fetchCities(value);
                setpatientDetails({ ...patientDetails, [name]: value, CityId: "", LocalityId: "" });
            }
            if (name === 'CityId') {
            ...
            setpatientDetails({ ...patientDetails, [name]: type === 'checkbox' ? checked : value });
        }
        if (name === "Name") {
            setpatientDetails({ ...patientDetails, [name]: value });
        }
    ...
    const updateDetails = () => {
        ...
        if (generatedError === "") {
            setLoading(true);
            axios.post("api/v1/updatehc/UpdateHCData", {
                "Age": Age,
                ...
                <div className="box-body" >
                    <div className="row ">
                        <div className='col-sm-3 d-flex'>
                            <label className="col-sm-1" htmlFor="inputEmail3" style={{ width: "50%" }}>
                                {t("Mobile No")}:
                            </label>
                            ...
                            <div className="box ">
                                <div className="box-body" >
                                    <div className="row" style={{ backgroundColor: "skyblue" }}>
                                        ...
                                        >
                                            <span
                                                style={{ backgroundColor: "papayawhip", border: "1px solid", }}
                                            >
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            </span>
                                            &nbsp;
                                            ...
                                            >
                                                <thead className="cf text-center" style={{ zIndex: 99 }}>
                                                    <tr>
                                                        ...
                                                        <th className="text-center">{t("Last HC Status")}</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    {phleboTable && phleboTable.map((ele, index) => (
                                                        <>
                                                            <tr key={index}
                                                                style={{ backgroundColor: ele.isreg ? 'papayawhip' : 'lightgreen' }}
                                                            >
                                                                ...
                                                                <td data-title="Select" className="text-center">
                                                                    <button className="btn  btn-info btn-sm"
                                                                        onClick={() => selectPatient(ele.Patientid)}
                                                                    >Select</button>
                                                                </td>
                                                                <td data-title="Patientid" className="text-center">
                                                                    {ele.Patientid}&nbsp;
                                                                </td>
                            ...
                            <div className="box-body" >
                                ...
                                <div className="box-body" >
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-sm-2">
                                            <div className="d-flex" >
                                                <div className="col-sm-2" style={{ width: "40%", margin: "0", padding: "0" }}>
                                                    <SelectBox
                                                        options={Title}
                                                        name="title"
                                                ...
                                                <div style={{ width: "70%" }}>
                                                    <Input
                                                        ...
                                                        onChange={handleChange}
                                                    />
                                                    {patientDetails?.FirstName === "" || patientDetails?.FirstName.length <= 4 && (
                                                        <><span className="golbal-Error">{errors?.FirstNameLength}</span><br /></>
                                                    )}
                                                    {!(/^\D*$/.test(patientDetails?.FirstName)) && (
                                                        <span className="golbal-Error">{errors?.FirstNameNumber}</span>
                                                    )}
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="col-sm-2">
                                            <div className="input-group-append d-flex">
                                                ...
                                                <Input
                                                    ...
                                                    onChange={handleDOBCalculation}
                                                />
                                                <span className="input-group-text form-control pull-right reprint-date input-sm justify-content-center" style={{ width: "20px" }}>
                                                    {t("M")}
                                                </span>
                                                <Input
                                                    className="select-input-box form-control input-sm"
                                        ...
                                        <div className="col-sm-2">
                                            <DatePicker
                                                name="DOB"
                                                date={patientDetails?.DOB ? new Date(patientDetails?.DOB) : new Date()}
                                                disabled={
                                                    RadioDefaultSelect === "Age" ? true : false
                                                }
                                                className="select-input-box form-control input-sm required"
                                                onChange={dateSelect}
                                                maxDate={new Date()}
                                    ...
                                    <div className='row'>
                                        ...
                                        <div className="col-sm-2">
                                            <SelectBox
                                                ...
                                                options={[{ label: 'Select Locality', value: '' }, ...Locality]}
                                            />
