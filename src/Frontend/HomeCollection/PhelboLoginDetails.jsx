...
const PhelboLoginDetails = () => {
  ...
  const searchLoginDetails = async () => {
    ...
    await axios
      .post("api/v1/HomeCollectionLoginDetail/GetData", {
  ...
  const handleShowSecondTable = async (id) => {
    await axios
      .post("api/v1/HomeCollectionLoginDetail/GetDetail", {
        FromDate: moment(searchData.FromDate).format("DD/MMM/YYYY"),
        ToDate: moment(searchData.ToDate).format("DD/MMM/YYYY"),
        PhlebotomistId: id,
      })
      ...
      <div className="box box-success">
        ...
        <div className="box-header with-border">
          <h3 className="box-title">
            Home Collection Phelbotomist Login Detail
          </h3>
        </div>
                        ...
                        {loading ? (
                          ...
                          <tr key={index}>
                            ...
                            <td data-title="Cancel" className="text-center">
                              <span
                                onClick={() =>
                                  handleShowSecondTable(ele.PhlebotomistId)
                                }
                              >
