...
function HomeCollectionDetailModal({ show, handleClose, ele, statusDetails }) {
  ...
  const getHappCode = (id) => {
    axios
      .post("api/v1/HomeCollectionSearch/ShowHappyCode", { PreBookingId: 5 })
      .then((res) => {
  ...
  const bindTest = () => {
    axios
      .post("api/v1/HomeCollectionSearch/BindItemDetail", {
            ...
            <div className="box-body">
              ...
              {ele?.CStatus == "Canceled" && (
                <div className="row">
                  ...
                  <div className="col-sm-2">
                    <span>{formData?.CancelDateTime}</span>
                  </div>
                  <label
                    className="col-sm-2"
                  ...
                  <div className="col-sm-2">
                    <span>{formData?.CancelReason}</span>
                  </div>
                  <label
                    className="col-sm-2"
                    htmlFor="Cancel By"
                  ...
                  <div className="col-sm-2">
                    <span>{formData?.CancelByName}</span>
                  </div>
                </div>
              )}
                    ...
                    {testDetails.map((ele, index) => (
                      <>
                        <tr key={index}>
                          ...
                          <td data-title="ItemID" className="text-center">
                            {ele?.ItemId} &nbsp;
                          </td>
                          <td data-title="Item Name" className="text-center">
                            {ele?.ItemName} &nbsp;{" "}
                          </td>
                          <td data-title="Item Type" className="text-center">
                            {ele?.ItemType} &nbsp;{" "}
                          </td>
                          ...
                          <td data-title="Net Amt" className="text-center">
                            {ele?.NetAmt} &nbsp;
                          </td>
                        </tr>
                      </>
